    var REV ="BETA (IN WORK)"
    var JSname="NextPlayer.js"
//Change first two variables for each revision===================================================    
    var JSdate;
...
//*PROGRAM and SONG VARS//===========================================================================
    ...
    var SONGlastCustom=0;//0=Key,1=Tempo,2=Track used for one time customizing song Key, Tempo, Track
...
function bogus() {
    alert(1);
    document.getElementById('buttonTrack').style.backgroundImage="url('../../Icons/blackSquare.png')"}
...
window.onload = function(){
    ...
    ARRsongSettings=('C;92;transCircleWhite.png').split(';');//Key-tempo-icon
...
function loadServerTrack(){//alert('loading Server Track')
    ...
    //document.getElementById('thinkIcon').src="../../Icons/trans.png";// Why?????????????????
    ...
    src ="";
    if(SOUNDmode=="SILENT"){
        SOUNDicon ="transSilent.png";
        document.getElementById('buttonTrack').style.backgroundImage="url('../../Icons/transSilent.png')";
        ...
        if(SOUNDmode=="BACK TRACK"){
            ...
            SOUNDicon ="transBackTrack.png";
            src="../Backing/"+TITLE+".mp3";}
        else if (SOUNDmode=="VOCAL"){
            BPM= hash(ARRlines[0],"BPM",BPM);
            //icon ="transVocal.png";
            SOUNDicon ="transVocal.png";
            src="../VOCAL/"+TITLE+".mp3";}
        ...
        var x = setTimeout(function(){//^ time to get the mp3 [arbitrary]
            ...
            document.getElementById('buttonTrack').style.backgroundImage="url('../../Icons/'+SOUNDicon)"
            document.getElementById('mirror').style.backgroundImage="url('../../Icons/'+SOUNDicon)";
            document.getElementById('thinkIcon').src="../../Icons/trans.png"; 
            alert('close out;'+SOUNDicon);
            //document.getElementById('mirror').innerHTML="";
...
function scrollSetup(img){//alert('scrollSetup()');//^ get the song data,songHeight,iframeHeight,Duration,ScrollConstant Run after you set the content of page
    ...
    //document.getElementById('keyIcon').innerHTML=KEY;
    document.getElementById("V").innerHTML="<X2>"+parseInt(VOL*100,10)+"%</X2>";
    ...
    //autoSize("songBar2",3.5,undefined,15,undefined);
    autoSize("songBar2",undefined,undefined,undefined,undefined);
    ...
    //autoSize("tool",undefined,undefined,30,undefined);
    ...
    if (ALT===true){document.getElementById('altSong').innerHTML=(SETlist[TUNEnum+1].split('|')[0]);}
    //showSetting();
    alert('THE SOUNDicon '+ SOUNDicon)
    document.getElementById('buttonTrack').style.backgroundImage="url('../../Icons/'+SOUNDicon)";
    document.getElementById('mirror').style.backgroundImage="url('../../Icons/'+SOUNDicon')";
    }
...
function setSoundMode(mode,icon){
        ...
        SONGlastCustom=2;//0=Key,1=Tempo,2=TrackIcon 
        ARRsongSettings.splice(2,1,icon);
        showSetting();
        SOUNDmode = mode;
        SOUNDicon=icon;
...
function showSetting() {// alert('showSetting('+num+')')
    ...
    //alert("SONG LAST NUMBER: "+ SONGlastCustom)
    if (num===0) {//set Icon to geneneric & text to key and move Icon down
        ...
        document.getElementById('mirror').style.backgroundImage="url('../../Icons/transCircleWhite.png')";}
    else{//set icon to backtrack and put it on top
        alert("THIS ICON: ../../Icons/"+SOUNDicon)
        document.getElementById('mirror').innerHTML="XXX";
        document.getElementById('mirror').style.backgroundImage="url('../../Icons/'+SOUNDicon)";
        document.getElementById('buttonTrack').style.backgroundImage="url('../../Icons/'+SOUNDicon)";
        }
    alert('../../Icons/'+SOUNDicon)}
 
function setCustom(VAR,val,action){
    //alert(VAR +">>"+val+">>"+action)
    if (!val){
...
function barSelect(bar,msg){   
        ...
        //var arrBar="configuration,information,tempo,tool,key-Selection,sound-track,songBar".split(",");//cloud,
        var j=0;  var ctrl;
        while (j<arrBar.length){   
            if (msg===undefined) {msg="...";}
            ctrl =arrBar[j];
            if (bar=='none'||bar!=ctrl) {dis(ctrl,'none');}
            else if (document.getElementById(ctrl).style.display=='block') {dis(ctrl,'none');}
            else{dis(ctrl,'block');}
            j = j+1;}
