...
function setHomeLocal(key){
  if (confirm("Make "+ key+ " the home base of local storage")==true ){
   localStorage.setItem("home", key )
   }else{return}
}
...
function goHomeLocal(){
   var key=document.getElementById('selectLocal').value=localStorage.getItem('home')
   document.getElementById('keyLocal').value =key
   document.getElementById('selectLocal').value=key;
   var key2=document.getElementById('selectLocal').value=key;
   var s=localStorage.getItem(key2)
   document.getElementById('valueLocal').value=s
}
