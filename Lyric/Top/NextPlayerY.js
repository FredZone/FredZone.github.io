...
function scrollSetup(img) { //^ get the song data,songHeight,iframeHeight,Duration,ScrollConstant Run after you set the content of page
 ...
 //  }
   ...
   alert("NOTEtype1211"+ NOTEtype)
   if (NOTEtype == 'Set') {
      notePopUp(NOTEtype, NOTEset);
   } else if (NOTEtype == "Tech") {
      notePopUp(NOTEtype, NOTEtech);
   } else if (NOTEtype == "Trivia") {
      notePopUp(NOTEtype, NOTEtrivia);
   } else if (NOTEtype == "Links") {
      notePopUp(NOTEtype, NOTElinks);
   }

   notePopUp("DOGSHIT","POOP")
...
function pickPop(id) {
   ...
   TRIVIAnotes = false
   LINKnotes=false
   document.getElementById('popNone').style.backgroundColor = 'white'
